...
The home page includes accessible category and publisher filters. Category selections can be combined, and publisher filtering can be applied at the same time; filtering updates the prerendered game cards in the browser without a runtime API.
